    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="container-main py-12">
        ...
        <div className="max-w-2xl">
          <h1 className="text-4xl font-serif font-light text-white mb-8">{t('createListing.title')}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {step === 'type' && (
              <div className="card space-y-4">
                <h2 className="text-2xl font-semibold text-white mb-6">{t('createListing.steps.typeTitle')}</h2>
                {[
                  'room_available',
                  'looking_for_room',
                  'looking_together',
            ...
            {step === 'details' && (
              <div className="card space-y-4">
                <h2 className="text-2xl font-semibold text-white mb-6">{t('createListing.steps.detailsTitle')}</h2>
            ...
            {step === 'amenities' && (
              <div className="card space-y-4">
                <h2 className="text-2xl font-semibold text-white mb-6">{t('createListing.steps.amenitiesTitle')}</h2>
            ...
            {step === 'photos' && (
              <div className="card space-y-4">
                <h2 className="text-2xl font-semibold text-white mb-6">{t('createListing.steps.photosTitle')}</h2>
